    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {formData.qualifications.map((qual, index) => (
              ...
              >
                <input
                  ...
                  required
                  className="md:col-span-1 block w-full px-3 py-2 border-gray-300 rounded-md"
                />
                <input
                  type="text"
                  name="university"
                  ...
                  onChange={(e) => handleQualificationChange(index, e)}
                  required
                  className="md:col-span-2 block w-full px-3 py-2 border-gray-300 rounded-md"
                />
                <input
                  type="number"
                  name="year"
                ...
                {formData.qualifications.length > 1 && (
                  <button
                    ...
                    className="md:col-span-4 text-red-500 hover:text-red-700 flex items-center justify-end text-sm"
                  >
          ...
          <div className="pt-4">
            {message && (
              <p className="text-blue-600 bg-blue-50 p-3 rounded-md mb-4 text-sm">
                {message}
              </p>
            )}
            {error && (
              <p className="text-red-600 bg-red-50 p-3 rounded-md mb-4 text-sm">
                {error}
              </p>
            )}
            <button
