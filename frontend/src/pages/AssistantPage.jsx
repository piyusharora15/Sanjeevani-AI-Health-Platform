...
const AssistantPage = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-100 via-slate-50 to-blue-50 py-6">
      <div className="max-w-6xl mx-auto px-4 pb-10">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-2/3 flex flex-col bg-white/90 backdrop-blur rounded-2xl shadow-lg border border-slate-200 p-4 md:p-5">
            ...
            {/* Chat area */}
            <div className="flex-1 min-h-[260px] max-h-[420px] bg-slate-50 rounded-xl shadow-inner p-3 md:p-4 overflow-y-auto mb-4">
