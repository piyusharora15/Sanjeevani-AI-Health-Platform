...
const HomePage = () => {
  ...
  return (
    <div className="bg-slate-50 text-gray-800">
      ...
      {/* --- REVAMPED FEATURES SECTION (FIXED) --- */}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-xl p-8 transform hover:-translate-y-2 transition-transform duration-300 shadow-sm hover:shadow-lg">
              ...
              <p className="text-gray-600">In critical situations, get immediate access to emergency contacts and directions.</p>
            </div>
          </div>
        </div>
      </section>
      
      {/* --- REVAMPED HOW IT WORKS SECTION (FIXED) --- */}
